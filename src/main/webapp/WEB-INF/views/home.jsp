...
<%@ include file="/WEB-INF/views/template/header.jsp" %>
        ...
        <div class="container marketing">
            ...
            <div class="row">
                <div class="col-lg-4">
                    <a class="btn btn-default" href="<c:url value="/product/productList?searchCondition=Personal Care Appliances" />" role="button">
                ...
                <div class="col-lg-4">
                    <a class="btn btn-default" href="<c:url value="/product/productList?searchCondition=Accessories" />" role="button">
                        <img class="img-responsive" width="255" height="255"src="<c:url value="/resources/images/record.jpg"/>" alt="Instrument Image" width="140" height="140">
                    </a>
                ...
                <div class="col-lg-4">
                    <a class="btn btn-default" href="<c:url value="/product/productList?searchCondition=Beauty and Personal Care" />" role="button">
